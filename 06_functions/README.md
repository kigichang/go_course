...
- [06 Functions](#06-functions)
  ...
  - [3. Pass by Value (Call by Value)](#3-pass-by-value-call-by-value)
    - [3.1 Pass by Value with Struct and Struct Pointer](#31-pass-by-value-with-struct-and-struct-pointer)
    - [3.2 Pass by Value with Aray and Slice](#32-pass-by-value-with-aray-and-slice)
  - [4. Signature](#4-signature)
    - [4.1 First-Class](#41-first-class)
...
### 3.1 Pass by Value with Struct and Struct Pointer
...
### 3.2 Pass by Value with Aray and Slice
